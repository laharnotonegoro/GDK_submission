    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(jajar_genjang.this, "Belum Dapat Dishare", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btn_kalkulator.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(jajar_genjang.this, "Belum Dapat Menghitung", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
